...
const file_v1alpha1_dataset_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tB*\xfaB'r%\x10\x01Z\x06modelsZ\bdatasetsZ\x06spacesZ\aresolveR\x04name\"y\n" +
	"\x14CreateDatasetRequest\x12!\n" +
	"\aproject\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\aproject\x12>\n" +
	"\x04name\x18\x02 \x01(\tB*\xfaB'r%\x10\x01Z\x06modelsZ\bdatasetsZ\x06spacesZ\aresolveR\x04name\"\x17\n" +
	"\x15CreateDatasetResponse\"y\n" +
	"\x14DeleteDatasetRequest\x12!\n" +
	"\aproject\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\aproject\x12>\n" +
	"\x04name\x18\x02 \x01(\tB*\xfaB'r%\x10\x01Z\x06modelsZ\bdatasetsZ\x06spacesZ\aresolveR\x04name\"\x17\n" +
	"\x15DeleteDatasetResponse\"\x80\x01\n" +
	"\x1bListDatasetRevisionsRequest\x12!\n" +
	"\aproject\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\aproject\x12>\n" +
	"\x04name\x18\x02 \x01(\tB*\xfaB'r%\x10\x01Z\x06modelsZ\bdatasetsZ\x06spacesZ\aresolveR\x04name\"S\n" +
	"\x1cListDatasetRevisionsResponse\x123\n" +
	"\x05items\x18\x01 \x01(\v2\x1d.matrixhub.v1alpha1.RevisionsR\x05items\"\xdf\x01\n" +
	...
	"\x02id\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x02id\"\xaa\x01\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x18.matrixhub.v1alpha1.FileR\x05items\"\xaa\x01\n" +
